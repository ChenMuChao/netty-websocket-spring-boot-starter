...
import com.adealink.weparty.servlet.handler.HttpServletRequestHandler;
import com.adealink.weparty.util.SpringContextUtils;
import com.adealink.weparty.util.SslUtils;
...
public class WebsocketServer {
    ...
    public void init(boolean enableHttpServlet) throws InterruptedException, SSLException {
                ...
                .childHandler(new ChannelInitializer<NioSocketChannel>() {
                    ...
                    protected void initChannel(NioSocketChannel ch) {
                        ...
                        if (enableHttpServlet) {
                            DispatcherServlet dispatcherServlet = SpringContextUtils.getBean(DispatcherServlet.class);
                            pipeline.addLast(HandlerNameConstant.HTTP_SERVLET_REQUEST_HANDLER, new HttpServletRequestHandler(finalEventExecutorGroup, dispatcherServlet));
                        }
                        pipeline.addLast(HandlerNameConstant.WEB_SOCKET_REQUEST_HANDLER, new HttpWebSocketServerHandler(pojoEndpointServer, config, finalEventExecutorGroup, corsConfig != null));
                    }
                });
